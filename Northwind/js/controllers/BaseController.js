...
(function(Northwind, $, serenity) {
  Northwind.Controllers.Base = serenity.Observable.extend({
    ...
    _activate: function() {
      ...
      $(serenity.format("#header .app-{0}", this.options.name.toLowerCase())).addClass("active");
    },
    ...
    _load: function(viewName, element) {
      ...
      return $.Deferred(function(deferred) {
        ...
        if (typeof that.__views[viewName] === "undefined") {
          ...
          $.get(serenity.format("views/{0}/{1}.html?_={2}", that.options.name, viewName, (new Date()).getTime()), function(html) {
